...
(function(global) {
	...
	for (let i = 0; i < population.length; i++) {
	    newPopulation.push(mutate(population[i], mutationRate));
	}
	...
	console.log("gen.", generationCount, "best", bestCandidate, "best fit", bestFitness, "prevBest", previoousGenerationBest, 'stepbacks', stepbacks);
